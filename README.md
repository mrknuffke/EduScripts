...
| [**`AP Score Predictor`**](file:///Users/davidknuffke/Documents/Programming/EduScripts/AP%20Score%20Predictor/README.md) | HTML Web App | Zero-install predictor & analytics dashboard (`v.26-27`) calibrated for Singapore American School. Generates defensible, provisional predicted AP Exam scores and Gaussian probability bands for UCAS applications and university advising. |
...
| [**`Test Development Tools`**](file:///Users/davidknuffke/Documents/Programming/EduScripts/Test%20Development%20Tools/README.md) | Mixed | AI-assisted assessment authoring tools. Currently includes `pe-cluster-builder`: generates single-PE item clusters (teacher draft, student paper, answer key, scoring sheet, Google Form) from a JSON spec for any NGSS or standards-based science course. |
